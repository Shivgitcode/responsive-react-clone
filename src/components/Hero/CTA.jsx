    ...
    <div className="flex w-full items-center justify-center gap-[8px]">
      <>
        <input
          ...
          id=""
          className="pt-[1.25rem] pb-[0.25rem] px-[1rem] bg-[#111010] rounded-sm  border-[0.2px] bg-transparent appearance-none relative placeholder:relative placeholder:-top-2"
        />
      </>
